---
name: speckit-charter-config
description: Configure the charter registry and select constitution fragments for
  composition
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: extension:charter
---

# Charter Config Skill
